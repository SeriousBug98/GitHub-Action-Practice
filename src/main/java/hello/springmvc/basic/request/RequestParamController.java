...
public class RequestParamController {
    ...
    /**
     * HTTP 파라미터 이름이 변수 이름과 같으면 @RequestParam의 name 속성을 생략할 수 있다.
     *
     * @param username
     * @param age
     * @return
     ...
     * <p>
     * /request-param-required?username= -> 빈문자로 통과 주의! /request-param-required int age -> null을 int에 입력하는 것은 불가능, 따라서
